...
class DB
{
    ...
    {
        $serverName = env("MYSQL_PORT_3306_TCP_ADDR", "rm-n9e14b6l0f998jsv2o.mysql.rds.aliyuncs.com");
        $databaseName = env("MYSQL_INSTANCE_NAME", "test_db");
        $username = env("MYSQL_USERNAME", "goupadhy");
        $password = env("MYSQL_PASSWORD", "Alibaba123$");
